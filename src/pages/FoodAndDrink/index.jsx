...
const img2 =
  "https://www.circlek.com.vn/wp-content/uploads/2021/10/BG_320x350.png";
const FoodDrink = () => {
      ...
      {pathname.split("/")[2] ? (
        ...
        <Box p={5}>
          ...
          <Typography align="center" fontWeight={500} p={2} variant="h5">
            Hãy đến ngay cửa hàng Circle K gần nhất để có những trải nghiệm thú
            vị với chúng tôi.
          </Typography>
          <Box
            display="flex"
          ...
          >
            ...
            >
              <Typography pt={6} pb={3}>
                ...
                thức uống từ nóng đến lạnh. Chúng tôi luôn có thức uống mới để
                bạn thưởng thức và trải nghiệm.
              </Typography>
              <Button
                variant="contained"
                color="primary"
            ...
            >
              <Typography pt={7} pb={3}>
                ...
                phổ biến, Circle K luôn mang đến cho bạn sự hài lòng như mong
                muốn.
              </Typography>
              <Button
                variant="contained"
            ...
            >
              ...
              >
                ...
                <Typography>
                  ...
                  bạn sẽ dễ dàng tìm được cửa hàng Circle K gần nhất.
                </Typography>
