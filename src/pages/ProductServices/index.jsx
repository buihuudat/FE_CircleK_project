...
const ProductServices = () => {
  return (
    <Box>
      <Typography align="center" variant="h4" fontWeight={600} color="red">
        MUA SẮM NHANH CHÓNG, TIỆN LỢI VÀ AN TOÀN
      </Typography>
      <Typography align="center">
        Hãy để Circle K đáp ứng các nhu cầu thiết thực trong cuộc sống hằng ngày
        của bạn như một điểm đến mua sắm 24/7.
      </Typography>
      ...
      <Box display={"flex"} justifyContent={"center"} gap={2} p={5}>
        ...
        >
          <Typography pt={10} variant={"h5"} pb={2}>
            Sản phẩm tại Circle K không những đa dạng về chủng loại, phong phú
            về thương hiệu mà còn chất lượng, giá cả hợp lý.
          </Typography>
        ...
        >
          ...
          >
            ...
            <Typography>
              ...
              dàng tìm được cửa hàng Circle K gần nhất.
            </Typography>
